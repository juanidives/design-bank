...
! function() {
  var e = {
        ...
        "document" in window.self && ((!("classList" in document.createElement("_")) || document.createElementNS && !("classList" in document.createElementNS("http://www.w3.org/2000/svg", "g"))) && function(e) {
          ...
          if ("Element" in e) {
            var t = "classList",
              ...
              u = function(e) {
                for (var t = i.call(e.getAttribute("class") || ""), o = t ? t.split(/\s+/) : [], r = 0, n = o.length; r < n; r++) this.push(o[r]);
            ...
            if (a[o] = Error[o], l.item = function(e) {
                return this[e] || null
                ...
                var e, t = arguments,
                  ...
                  n = !1;
                do {
                  -1 === c(this, e = t[o] + "") && (this.push(e), n = !0)
                } while (++o < r);
                ...
                var e, t, o = arguments,
                  ...
                  i = !1;
                do {
                  for (t = c(this, e = o[r] + ""); - 1 !== t;) this.splice(t, 1), i = !0, t = c(this, e)
                } while (++r < n);
              ...
              try {
                ...
                void 0 !== e.number && -2146823252 !== e.number || (f.enumerable = !1, n.defineProperty(r, t, f))
              }
            } else n[o].__defineGetter__ && r.__defineGetter__(t, d)
          }
      ...
      810: function() {
        ! function() {
          if ("undefined" != typeof window) try {
            ...
            var t = function(e, t) {
              var o, r;
              return (t = t || {}).bubbles = !!t.bubbles, t.cancelable = !!t.cancelable, (o = document.createEvent("CustomEvent")).initCustomEvent(e, t.bubbles, t.cancelable, t.detail), r = o.preventDefault, o.preventDefault = function() {
                r.call(this);
                try {
      ...
      237: function() {
        ...
        function r(e, r) {
          ...
          s.open("POST", e, !i), s.withCredentials = !0, s.setRequestHeader("Accept", "*/*"), t(r) ? (s.setRequestHeader("Content-Type", "text/plain;charset=UTF-8"), s.responseType = "text") : o(r) && r.type && s.setRequestHeader("Content-Type", r.type);
          try {
            s.send(r)
          } catch (e) {
            return !1
          ...
          "function" != typeof this.navigator.sendBeacon && (this.navigator.sendBeacon = r.bind(this))
      ...
      147: function(e, t, o) {
        ...
        var r = "undefined" != typeof globalThis && globalThis || "undefined" != typeof self && self || void 0 !== o.g && o.g || {},
          n = {
        ...
        function p() {
          return this.bodyUsed = !1, this._initBody = function(e) {
            ...
            var e, t, o, r, n, i = d(this);
            if (i) return i;
            if (this._bodyBlob) return e = this._bodyBlob, t = new FileReader, o = f(t), r = /charset=([A-Za-z0-9_-]+)/.exec(e.type), n = r ? r[1] : "utf-8", t.readAsText(e, n), o;
            if (this._bodyArrayBuffer) return Promise.resolve(function(e) {
              for (var t = new Uint8Array(e), o = new Array(t.length), r = 0; r < t.length; r++) o[r] = String.fromCharCode(t[r]);
              return o.join("")
        ...
        function m(e, t) {
          ...
          if (this.credentials = t.credentials || this.credentials || "same-origin", !t.headers && this.headers || (this.headers = new l(t.headers)), this.method = (o = t.method || this.method || "GET", n = o.toUpperCase(), b.indexOf(n) > -1 ? n : o), this.mode = t.mode || this.mode || null, this.signal = t.signal || this.signal || function() {
        ...
        }, p.call(m.prototype), p.call(_.prototype), _.prototype.clone = function() {
        ...
        function k(e, t) {
          return new Promise((function(o, i) {
            ...
            if (u.onload = function() {
              ...
              }(s.url), !0), "include" === s.credentials ? u.withCredentials = !0 : "omit" === s.credentials && (u.withCredentials = !1), "responseType" in u && (n.blob ? u.responseType = "blob" : n.arrayBuffer && (u.responseType = "arraybuffer")), t && "object" == typeof t.headers && !(t.headers instanceof l || r.Headers && t.headers instanceof r.Headers)) {
              var f = [];
        ...
        k.polyfill = !0, r.fetch || (r.fetch = k, r.Headers = l, r.Request = m, r.Response = _)
      }
    },
    t = {};
  ...
  o.d = function(e, t) {
    ...
    }, o(147), o(810), o(241), o(237), Element.prototype.toggleAttribute || (Element.prototype.toggleAttribute = function(e, t) {
      return void 0 !== t && (t = !!t), this.hasAttribute(e) ? !!t || (this.removeAttribute(e), !1) : !1 !== t && (this.setAttribute(e, ""), !0)
    ...
    function() {
      if (! function() {
          try {
            const e = {
                registeredDomain: "fantasy.co",
                currentDomain: window.location.hostname
              },
              t = e.registeredDomain.replace(/^www\./, ""),
              o = e.currentDomain.replace(/^www\./, "").split(".");
            for (let e = 0; e < o.length; e++) {
              if (o.slice(e).join(".") === t) return !0
            }
            return !1
          } catch (e) {
            return !1
      ...
      if (!!(!window.cookieyes || !window.cookieyes._ckyStore)) {
        ...
        o._ckyGetCookieMap = function() {
          ...
          return e
        }, o._ckySetCookie = function(e, t) {
          let r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0,
            n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : o._ckyStore._rootDomain;
          const i = new Date,
            s = 0 === r ? 0 : i.setTime(i.getTime() + 24 * r * 60 * 60 * 1e3),
          ...
          const o = (t ? "0123456789" : "") + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghiklmnopqrstuvwxyz",
            r = [];
          for (let t = 0; t < e; t++) r.push(o[Math.floor(Math.random() * o.length)]);
          return t ? btoa(r.join("")).replace(/\=+$/, "") : r.join("")
        }, o._ckyIsCategoryToBeBlocked = function(e) {
          const t = o._ckyGetFromStore(e);
          return "no" === t || !t && o._ckyStore._categories.some((t => t.slug === e && !t.isNecessary))
        ...
        }, o._ckyConsentStore = new Map, o._ckyGetFromStore = function(e) {
        ...
        o._ckySetInStore = function(e, t) {
          ...
          const r = [];
          for (const [e, t] of o._ckyConsentStore) r.push(`${e}:${t}`);
        ...
        ["consentid", "consent", "action"].concat(o._ckyStore._categories.map((e => {
            ...
            return t
          }))).map((e => o._ckyConsentStore.set(e, n[e] || ""))), o._ckySendPageViewLog = function(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "";
            try {
              const r = {
                ...
                n = new FormData;
              n.append("key", "ced343fcba4c8ee12f420d15"), n.append("request_type", e), n.append("event_log_time", Math.round(Date.now() / 1e3)), n.append("payload", JSON.stringify(r)), navigator.sendBeacon("https://log.cookieyes.com/api/v1/log", n)
            } catch (e) {
              console.error(e)
            }
          },
          function() {
            if (o._ckyGetFromStore("consentid")) return;
            const e = o._ckyRandomString(32);
            o._ckySetInStore("consentid", e), o._ckyStore._resetConsentID = !0
          }(), o._ckySendPageViewLog("banner_load");
        try {
          o._ckyCreateElementBackup = document.createElement, document.createElement = function() {
            for (var e = arguments.length, r = new Array(e), n = 0; n < e; n++) r[n] = arguments[n];
            const i = o._ckyCreateElementBackup.call(document, ...r);
            if ("script" !== i.nodeName.toLowerCase()) return i;
            ...
            return Object.defineProperties(i, {
              src: {
                ...
                set: function(e) {
                  return t(i, e) && s("type", "javascript/blocked"), s("src", e), !0
                },
                configurable: !0
              },
              type: {
                ...
                set: function(e) {
                  return e = t(i) ? "javascript/blocked" : e, s("type", e), !0
                },
                configurable: !0
              }
            }), i.setAttribute = (e, o) => {
              if ("type" === e || "src" === e) return i[e] = o;
              s(e, o), "data-cookieyes" !== e || t(i) || s("type", "text/javascript")
            }, i
          }
        } catch (s) {
          console.error(s)
        ...
        function e(t) {
          if (t.nodeName)
            if (["script", "iframe"].includes(t.nodeName.toLowerCase())) ! function(e) {
              try {
                ...
                if (function(e, t) {
                    ...
                    i ? i.isOverriden ? i.categories.includes(n) || i.categories.push(n) : (i.categories = [n], i.isOverriden = !0) : o._ckyStore._providersToBlock.push({
                      url: t,
                      categories: [n],
                      fullPath: !1
                    })
                  }(e, i), !o._ckyShouldBlockProvider(i)) return;
                const s = o._ckyRandomString(8, !1);
                if ("iframe" === e.nodeName.toLowerCase()) ! function(e, t) {
                  let {
                    offsetWidth: o,
                    offsetHeight: r
                  } = e;
                  if (0 === o || 0 === r) {
                    if (({
                        ...
                        if (!parseInt(t) || !parseInt(o)) return {
                          offsetWidth: null,
                          offsetHeight: null
                        };
                        return {
                  ...
                  n.style.width = o, n.style.height = r;
                  ...
                  if (!s) return;
                  n.classList.replace("video-placeholder-normal", "video-placeholder-youtube"), n.style.backgroundImage = `linear-gradient(rgba(76,72,72,.7),rgba(76,72,72,.7)),url('https://img.youtube.com/vi/${s}/maxresdefault.jpg')`, i.classList.replace("video-placeholder-text-normal", "video-placeholder-text-youtube")
                }(e, s), o._ckyStore._bannerAttached && o._ckySetPlaceHolder && o._ckySetPlaceHolder(s);
                else {
                  e.type = "javascript/blocked";
                  const t = function(o) {
                    o.preventDefault(), e.removeEventListener("beforescriptexecute", t)
                  };
                ...
                e.remove(), o._ckyStore._backupNodes.push({
                  position: a,
                  node: e.cloneNode(),
                  uniqueID: s
                })
            ...
            for (const o of t.childNodes) e(o)
        }
        ...
        i.src = "https://cdn-cookieyes.com/client_data/ced343fcba4c8ee12f420d15/banner.js", i.async = !0, i.id = "cookieyes-banner", document.head.appendChild(i)
      }
    }()
}();
