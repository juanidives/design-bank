! function() {
  ...
  var e = "MEMBER";
  t(r = {}, "GUEST", "li_gc"), t(r, e, "li_mc");
  var a = function(r) {
      return /^\d+$/.test(r)
    },
    i = function() {
      try {
        var r = Number(n.IT_TREATMENT || 0),
          t = n.IT_ALLOW || {},
          e = n.IT_BLOCK || {};
        return function(r, n, t, e) {
          ...
          if (r._bizo_data_partner_id && (n[r._bizo_data_partner_id] = !0, t.push(r._bizo_data_partner_id)), r._bizo_data_partner_ids)
            for (var e = 0, i = r._bizo_data_partner_ids; e < i.length; e++) !n[s = i[e]] && a(s) && (n[s] = !0, t.push(s));
    ...
    }() ? "/assets/js/insight.beta.min.js" : "/assets/js/insight.old.min.js",
    _ = document.createElement("script"),
    d = document.getElementsByTagName("script")[0];
  _.async = !0, _.src = i, d.parentNode && d.parentNode.insertBefore(_, d)
}();
